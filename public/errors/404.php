...
<html lang="en">
<head>
    <title>Stamp error page Widget a Flat Responsive Widget Template :: w3layouts</title>
    <!--meta tags -->
    <meta charset="UTF-8">
    ...
    <!-- Meta tag Keywords -->
    <link rel="stylesheet" href="/errors/web/css/style.css" type="text/css" media="all" /> <!-- Style-CSS -->
...
<div class="main">
    <h1>404</h1>
    <p>
        Ooops, Something Goes Wrong...<br/>That's a trouble?</p>
    <button type="button"><a href="<?=PATH;?>">Go back</a></button>
    <div class="copyright">
